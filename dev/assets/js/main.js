...
function findVideos() {
  let videos = document.querySelectorAll('.youtube__video');
...
function setupVideo(video) {
  let link = video.querySelector('.youtube__video-link');
  let media = video.querySelector('.youtube__video-media');
  let button = video.querySelector('.youtube__video-btn');
  ...
  video.addEventListener('click', () => {
      ...
      video.classList.add('youtube__video--enabled');
  });
...
function createIframe(id) {
  ...
  iframe.classList.add('youtube__video-media');
